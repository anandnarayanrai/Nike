 ...
 * [MyTeamFragment.OnFragmentInteractionListener] interface
...
class MyTeamFragment : Fragment() {
    ...
    private lateinit var adapterMyTeam: AdapterMyTeam
    ...
    override fun onCreateView(
        ...
        var rvMyTeam: RecyclerView = view.findViewById(R.id.rvMyTeam)
        rvMyTeam.layoutManager = LinearLayoutManager(context)
        adapterMyTeam = AdapterMyTeam(context!!)
        rvMyTeam.adapter = adapterMyTeam
